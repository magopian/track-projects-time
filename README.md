...
As a freelancer, I need to track how much time I spend on a given project. The aim is to be able to add an entry with

* the project name
* a description
* the time spent in (fraction of) days
* the day when the time was spend
* the invoiced or paid status of this time spent

Maybe in the future it would be nice to be able to

* [done] list all the entries for a given project
* [done] list all the entries for a given project since a given date
* [done] sum all the days spent on a given project
...
- [Track projects time](#track-projects-time)
- [Elm App](#elm-app)
